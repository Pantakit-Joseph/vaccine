		...
		<div class="w3-row-padding w3-margin-bottom">
			<div class="w3-quarter">
				<div class="w3-container w3-red w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= countParentAll($majors->stats) ?></h3>
					</div>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-blue w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= $majors->stats->inject . '(' . percent($majors->stats->inject, countParentAll($majors->stats)) . '%)' ?></h3>
					</div>
					<div class="w3-clear"></div>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-teal w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= $majors->stats->not_inject . '(' . percent($majors->stats->not_inject, countParentAll($majors->stats)) . '%)' ?></h3>
					</div>
					<div class="w3-clear"></div>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-orange w3-text-white w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= $majors->stats->no_data . '(' . percent($majors->stats->no_data, countParentAll($majors->stats)) . '%)' ?></h3>
					</div>
					<div class="w3-clear"></div>
			...
			<div class="w3-row-padding" style="margin:0 -16px">
				...
				<div class="">
					...
					<table class="w3-table w3-striped w3-white">
						<tr>
							<th colspan="2" style="text-align: center;">สาขาวิชา</th>
							<th>ฉีดวัคซีนแล้ว</th>
						...
						<?php
						foreach ($majors->items as $item) {
							
						?>
						<tr>
							<td><a href="<?= site_url('report_parent/major?major_id='.$item->major_id) ?>"><i class="fa fa-eye w3-text-yellow w3-large"></i></a></td>
							<td><a href="<?= site_url('report_parent/major?major_id='.$item->major_id) ?>"><?= $item->major_name ?></a></td>
