	...
	<div class="w3-main" style="margin-left:300px;margin-top:43px;">
		...
		<header class="w3-container" style="padding-top:22px">
			...
			<h4>
				...
				<a href="<?= site_url('report_parent/major?major_id='.$minor->major_id) ?>">สาขาวิชา<?= $minor->major_name ?></a>/
				<a href="<?= site_url('report_parent/minor?major_id='.$minor->major_id.'&minor_id='.$minor->minor_id) ?>">สาขางาน<?= $minor->minor_name ?></a>
			</h4>
		</header>
		...
		<div class="w3-row-padding w3-margin-bottom">
			<div class="w3-quarter">
				<div class="w3-container w3-red w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= countParentAll($minor->stats) ?></h3>
					</div>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-blue w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= $minor->stats->inject . '(' . percent($minor->stats->inject, countParentAll($minor->stats)) . '%)' ?></h3>
					</div>
					<div class="w3-clear"></div>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-teal w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= $minor->stats->not_inject . '(' . percent($minor->stats->not_inject, countParentAll($minor->stats)) . '%)' ?></h3>
					</div>
					<div class="w3-clear"></div>
			...
			<div class="w3-quarter">
				<div class="w3-container w3-orange w3-text-white w3-padding-16">
					...
					<div class="w3-right">
						<h3><?= $minor->stats->no_data . '(' . percent($minor->stats->no_data, countParentAll($minor->stats)) . '%)' ?></h3>
					</div>
					<div class="w3-clear"></div>
			...
			<div class="w3-row-padding" style="margin:0 -16px">
				...
				<div class="">
					...
					<table class="w3-table w3-striped w3-white">
						<tr>
							<th colspan="2" style="text-align: center;">กลุ่ม</th>
							<th>ฉีดวัคซีนแล้ว</th>
						...
						<?php
						foreach ($minor->items as $item) {
							
						?>
						<tr>
							<td><a href="<?= site_url('report_parent/group?major_id='.$minor->major_id.'&group_id='.$item->group_id) ?>"><i class="fa fa-eye w3-text-yellow w3-large"></i></a></td>
							<td><a href="<?= site_url('report_parent/group?major_id='.$minor->major_id.'&group_id='.$item->group_id) ?>"><?= $item->group_name ?></a></td>
